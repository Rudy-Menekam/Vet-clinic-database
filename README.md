...
> It is a relational database to create the data structure for a vet clinic.
...
```sh
  cd my-folder
  git clone https://github.com/Rudy-Menekam/Vet-clinic-database.git
```
-
<!-- 
### Install
...
Feel free to check the [issues page](https://github.com/Rudy-Menekam/Vet-clinic-database/issues/).
